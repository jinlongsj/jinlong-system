...
%>
			        ...
			        <div class="con_ri_head">
			            <span>首页</span> > <span>用户信息管理</span>> <span>添加用户信息</span>
			        </div>
		        	...
		        	<form id="add_base_form" name="add_base_form" method="post" class="form">
		        	...
		        	<form id="add_info_form" name="add_info_form" method="post" class="form">
		        		...
		        		<div class="con_box2">
		                    <ul class="cy2">
		                        ...
		                        <li>
                                    ...
                                    <input type="radio" id="gender" name="gender" value="1" checked="checked" style="display: inline-block; width: 20px;height: 15px;"/>
             						<label>女</label>
					...
					<!-- 添加用户JS -->
					<script type="text/javascript" charset="utf-8" src="<%=path%>/js/user/user_add.js"></script>